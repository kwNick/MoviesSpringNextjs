...
const page = () => {
    return (
        <div className="w-full h-[80vh] flex flex-col items-center justify-center">
            <div>
                <p className="underline text-lg lg:text-2xl xl:text-3xl">Signup</p>
            </div>

            <form className="p-2 flex flex-col items-center justify-center text-center gap-y-3 lg:gap-y-5 xl:gap-y-7">
                <div className="relative">

                    <input id="email" type="text" className="input rounded-lg p-1 text-contrast" required />
                ...
                <div className="relative">
                    ...
                    <input id="userName" type="text" className="input rounded-lg p-1 text-contrast" required />
                ...
                <div className="relative">
                    ...
                    <input id="password" type="text" className="input rounded-lg p-1 text-contrast transition-all duration-300 focus:outline-none focus:shadow-accent focus:shadow-inner " required />
                ...
                <div>
                    <button type="submit" className="border rounded-lg p-2">Signup</button>
                </div>
                <p className="text-xs">
