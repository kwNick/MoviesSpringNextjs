    ...
    return (
        <div className="w-full h-[90vh] flex flex-col items-center justify-center gap-y-3">
            ...
            <form className="relative p-2 flex flex-col items-center justify-center text-center gap-y-3 lg:gap-y-5 xl:gap-y-7">
                ...
                <div className="relative">
                    <input id="password" type="text" className="input rounded-lg p-1 text-contrast transition-all duration-300 lg:w-72 xl:w-80" required />
                ...
                <Link href={"#"} className="underline text-xs lg:text-base xl:text-lg">
                    Forgot Password?
                </Link>

                <div>
                    <button type="submit" className="border rounded-lg p-2 lg:px-4 lg:py-3 xl:p-5 xl:py-4 lg:text-lg xl:text-xl">Login</button>
                </div>
