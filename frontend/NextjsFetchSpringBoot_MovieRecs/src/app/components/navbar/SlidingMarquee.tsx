...
const SlidingMarquee = async () => {
    ...
    return (
        <>
            <div className="group absolute bottom-0 left-0 w-full h-[20] flex items-center text-xs tracking-widest text-nowrap opacity-40 hover:opacity-100  duration-300 before:absolute before:bg-accent before:opacity-40 before:bottom-0 before:left-0 before:w-full before:h-full ">
                <div className="flex">
