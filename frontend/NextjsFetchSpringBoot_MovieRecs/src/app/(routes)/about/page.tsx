        ...
        <div className="w-full min-h-[120vh] flex flex-col items-center space-y-8 lg:space-y-10 xl:space-y-12 p-4 lg:px-5 xl:px-6 py-6 lg:py-7 xl:py-8">
            ...
            <div className="w-full min-h-[200vh] border-x-2 border-colour/40">
                <div className="w-full h-full flex flex-col items-center justify-start space-y-4 lg:space-y-6 xl:space-y-8">
                    ...
                    <div className="group w-full h-[80vh] pt-16 lg:pt-24 xl:pt-28 flex items-start justify-start ">
                        <div className="min-w-1/5 flex justify-end text-end border-b-2 border-colour/40 pr-10 lg:pr-12 xl:pr-14">
                            <h2 className="text-2xl lg:text-3xl xl:text-4xl text-accent border-b-2 border-accent/40 duration-300">Our Mission</h2>
                        </div>
                        <div className="h-full border-l-2 border-colour/40">
                    ...
                    <div className="w-full h-[80vh] flex items-start justify-start">
                        <div className="min-w-2/5 flex justify-end border-b-2 border-colour/40 pr-10 lg:pr-12 xl:pr-14">
                    ...
                    <div className="w-full h-[80vh] flex items-start justify-start">
                        <div className="min-w-3/5 flex justify-end border-b-2 border-colour/40 pr-10 lg:pr-12 xl:pr-14">
