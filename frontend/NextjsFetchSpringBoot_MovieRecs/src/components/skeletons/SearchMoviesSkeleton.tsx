...
const SearchMoviesSkeleton = () => {
    return (
        <div className={` w-full min-h-full overflow-hidden`}>
                <div className={` w-full min-h-full flex flex-wrap justify-center overflow-hidden`}>

                    <div className={`${shimmer} relative w-2/5 h-[20vh] flex flex-col p-3 m-3 items-center rounded-lg border border-colour/20 overflow-hidden`}>
                        {/* MovieDaTa */}
                        <div className={``}>
                            <p className={``}></p>
                            <p className={``}></p>
                        ...
                        <div className={`container flex gap-3 justify-around overflow-hidden`}>
                            ...
                            <form
                                action={`#`}
                                 className={``}
                            >
                                <button type="submit" className={` w-20 h-12 border border-colour/20 p-2 duration-500 `}>
                                </button>
                            </form>
                        </div>
                    </div>
